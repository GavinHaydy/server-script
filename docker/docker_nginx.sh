...
echo "==========================================================start nginx============================================================="
docker run -d --name nginx -p 18080:80 -v /data/wwwroot/nginx/nginx.conf:/etc/nginx/nginx.conf -v /data/wwwroot/nginx/logs:/var/log/nginx -v /data/wwwroot/nginx/html/:/usr/share/nginx/html -v /data/wwwroot/nginx/conf/:/etc/nginx/conf.d --privileged=true nginx
docker ps
